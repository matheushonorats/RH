...
function obterFuncoesApiPermitidas_() {
  return {
    ...
    listarAutorizacoesCompensacaoRep: listarAutorizacoesCompensacaoRep,
    ...
    salvarAbonoEleitoral: salvarAbonoEleitoral,
    obterResumoAbonosEleitorais: obterResumoAbonosEleitorais,
    ...
    obterDadosEdicaoProtocolo: obterDadosEdicaoProtocolo,
    salvarEdicaoProtocolo: salvarEdicaoProtocolo,
