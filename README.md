...
A V2.3.154 adiciona uma estratégia em camadas:
...
A V2.3.154 entrega o pacote de estabilidade, desempenho, reorganização visual, fila segura, validações adicionais, tela de escolha de versão, proteção de capacidade, edição de feriados por competência, confirmação discreta da leitura do ponto, salvamento consciente de marcações a conferir e preservação do servidor do formulário durante atualizações em segundo plano.
...
2. O navegador baixa cada arquivo em partes; a V2.3.154 trabalha com até dois arquivos em paralelo.
...
- A V2.3.154 impede desperdício de células e arquiva crescimento técnico, mas ainda não particiona `Lançamentos` e tabelas REP funcionais por ano.
